...
{
    /// <summary>敌人被击杀发放的奖励（肥料、能量；漏怪撞基地不应触发）。</summary>
    public static event Action<int, int> EnemyDefeatedReward;
    ...
    public static void TriggerEnemyDefeatedReward(int fertilizerReward, int energyReward) =>
        EnemyDefeatedReward?.Invoke(fertilizerReward, energyReward);
